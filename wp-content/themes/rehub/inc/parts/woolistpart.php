...
<div class="rehub_feat_block woocommerce table_view_block <?php echo $reveal_enabled; echo $coupon_style; echo $deal_type; ?>">
    ...
    <div class="block_with_coupon <?php echo $deal_type;?>">
        <div class="offer_thumb"> 
            ...
            <a href="<?php echo $woolink; ?>"<?php if ($product->get_type() =='external'){echo ' target="_blank" rel="nofollow" '; echo $outsidelinkpart; } ?>>
        ...
        <div class="desc_col">             
            <h3><a href="<?php echo $woolink; ?>"<?php if ($product->get_type() =='external'){echo ' target="_blank" rel="nofollow"'; echo $outsidelinkpart; } ?>><?php echo rh_expired_or_not($post->ID, 'span');?><?php $title = get_the_title(); echo wp_trim_words( $title, 10, '...' ) ?></a></h3>
            <p>
