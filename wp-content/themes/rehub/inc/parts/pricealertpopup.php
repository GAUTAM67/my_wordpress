                    ...
                    <div class="csspopupinner cegg-price-alert-popup">
                        ...
                        <div class="cegg-price-alert-wrap">                       
                            ...
                            <div class="mb20 font90">
                                <?php _e('Lowest price Product', 'rehub_framework'); ?>: <?php echo $syncitem['title'];?> - <?php echo ContentEgg\application\helpers\TemplateHelper::formatPriceCurrency($syncitem['price'], $syncitem['currencyCode']); ?>
                            </div>                     
                            <form>
