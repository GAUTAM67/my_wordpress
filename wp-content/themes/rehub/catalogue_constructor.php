    ...
    <div class="rh-content-wrap clearfix">
        ...
        <div class="main-side page clearfix">          		
            ...
            <?php while ($wp_query->have_posts()) : $wp_query->the_post();?>
                <article class="<?php if ($catalog_style =='grid_three') :?>column_grid col_item<?php elseif($catalog_style =='grid_two') :?>small_post grid_catalog<?php else :?>list_grid<?php endif; ?>">
