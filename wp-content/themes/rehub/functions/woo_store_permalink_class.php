...
class WC_RH_Admin_Permalink_Stores {
	...
	public function product_store_slug_input() {
		...
		?>
		<input name="woocommerce_product_store_slug" type="text" class="regular-text code" value="<?php if ( isset( $permalinks['store_base'] ) ) echo esc_attr( $permalinks['store_base'] ); ?>" placeholder="store" />
		<?php
	}
	/**
	 * Save the settings.
