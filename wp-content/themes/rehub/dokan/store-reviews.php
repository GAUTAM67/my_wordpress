...
$vendor_name = $store_user->display_name;
...
$store_address = '';
if( $store_address_arr['street_1'] ) $store_address = $store_address_arr['street_1'];
if( $store_address_arr['street_2'] ) $store_address .= ', '. $store_address_arr['street_2'];
if( $store_address_arr['city'] ) $store_address .= ', '. $store_address_arr['city'];
if( $store_address_arr['state'] ) $store_address .= ', '. $store_address_arr['state'];
if( $store_address_arr['zip'] ) $store_address .= ' '. $store_address_arr['zip'];
if( $store_address_arr['country'] ) $store_address .= ', '. $store_address_arr['country'];
                    ...
                    <ul class="category-vendormenu">
                        ...
                        <li<?php echo $liclass;?>>
                            <?php $author_posts = new WP_Query( array( 
                                ...
                                wp_reset_query();
                            ?>
                            <a href="<? echo $store_url .'section/'. $category->ID ?>" title="<?php echo $category->name ?>">
