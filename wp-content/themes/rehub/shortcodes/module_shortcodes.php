...
<?php elseif ($style == 1):?>  
    <div class="loading carousel-style-fullpost">
        <div class="re_carousel eq_grid post_eq_grid" data-showrow="<?php echo $showrow;?>" <?php echo $autodata;?> data-laizy="0">
	        <?php $result_cat = array(); 
	            $deal_carousel = new WP_Query($args); 
	            if( $deal_carousel->have_posts() ) :
	            while($deal_carousel->have_posts()) : $deal_carousel->the_post();
...
<?php $compactclass = ($carouseltype == 'compact') ? ' woo_sell_block carousel-style-2 carousel-style-deal' : ' carousel-style-fullpost' ;?>
...
<div class="woo_carousel_block loading woocommerce showrow-<?php echo $showrow;?><?php echo $compactclass;?>">
