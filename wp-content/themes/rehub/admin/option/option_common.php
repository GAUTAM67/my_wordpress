			...
			array(
				...
				'fields' => array(
					array(
						...
						'description' => __('Deprecated - please, disable this and use Offer Module of Content Egg to add manual multioffers for posts', 'rehub_framework'),							
						'default' => '0',							
					),
					array(
						'type' => 'toggle',
					...
					array(
						'type' => 'toggle',
						'name' => 'enable_button_bottom',
						'label' => __('Enable Button in end of content', 'rehub_framework'),
						'description' => __('When enabled, you will see copy of Button for main offer of post after content', 'rehub_framework'),													
						'default' => '0',							
					),										
					array(
						'type' => 'toggle',
