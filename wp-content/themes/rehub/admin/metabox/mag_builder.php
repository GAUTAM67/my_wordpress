			...
			'fields'    => array(
				...
				array(
					...
					'items' => array(
						...
						array(
							'value' => 'video_block',
							'label' => __('Video playlist', 'rehub_framework'),
			    ...
			    array(
					...
					'sortable'  => false,
					'name'      => 'video_mod',
					'title'     => __('Video playlist', 'rehub_framework'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
					...
					'fields'    => array(
						...
						array(
							'type' => 'textbox',
							'name' => 'videolinks',
							'label' => __( 'Links on videos', 'rehub_framework' ),
							'description' => __( 'Place links on videos with comma delimiter. Works with youtube and vimeo. Example for youtube: https://www.youtube.com/watch?v=ZZZZZZZZZZZ. Example for vimeo: https://vimeo.com/111111111', 'rehub_framework' ),							
							'default' => '',
						),	
						...
						array(
							'type' => 'select',
							'name' => 'playlist_host',
							'label' => __('Video host', 'rehub_framework' ),
							'items' => array(
								array(
									'value' => 'youtube',
									'label' => __('youtube', 'rehub_framework'),
								),
								array(
									'value' => 'vimeo',
									'label' => __('vimeo', 'rehub_framework'),
								),
							),
							'default' => array(
								'youtube',
			    ...
			    array(
					...
					'fields'    => array(
						...
						array(
							...
							'description' => __('Set the tag (slug) that you\'d like to include to block', 'rehub_framework'),							
							'default' => '',																																						
						),
