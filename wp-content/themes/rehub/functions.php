...
function rehub_framework_register_scripts() {
	...
	// Stylesheets
	wp_register_style('rhstyle', get_stylesheet_directory_uri() . '/style.css', array(), '6.9.1.2');
	wp_register_style('responsive', get_template_directory_uri() . '/css/responsive.css', array(), '6.9.1');
	...
	wp_register_style( 'rehub-woocommerce', get_template_directory_uri().'/css/woocommerce.css', array(), '6.9.1', 'all' );
	...
	wp_register_style('eggrehub', get_template_directory_uri() . '/css/eggrehub.css', array(), '6.8.9');
	...
	wp_register_style('rhwcvendor', get_template_directory_uri() . '/css/wcvendor.css', array(), '6.9.1.2');
